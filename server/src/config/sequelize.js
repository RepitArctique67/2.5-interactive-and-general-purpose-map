...
// Create Sequelize instance with PostGIS support or SQLite fallback
...
const testConnection = async () => {
    try {
        ...
        logger.info(`✅ Sequelize: Database connection established successfully (${isSqlite ? 'SQLite' : 'PostgreSQL'})`);
